...
form.addEventListener('submit', function (e) {
    ...
    if (dataTaskId) {
        ...
        alertMessage('Todo was edited', className = 'alert-info')
    } else {
        addNewTodoToStorage(title.value, text.value);
        alertMessage('New todo was added', className = 'alert-info')
    }
...
function deleteTodoFromView(id) {
    ...
    alertMessage('Todo was deleted', className = 'alert-danger')
...
function removeAlert() {
    ...
    if (currentAlert) {
        formCol.removeChild(currentAlert)
    }
